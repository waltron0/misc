// SHOULD PROLLY JUST START SOMETHING NEW, YOU CAN MAKE SOME DUMB RANDOM NUMBER DATA MAKER WHICH PRODUCES WITH A BUTTON, THEN PLOTTER, CUZ TRANSLATING YOUR OTHER THING IS TOO WEIRD FOR NOW
